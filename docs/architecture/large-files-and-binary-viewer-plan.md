...
| B1 | Tab kinds in `app-core`; `open_file` opens binary files | done | `4b02300` (#66) |
| B2 | `BinaryFile` + hex row formatting in `editor-core` | done | `4b02300` (#66) |
| B3 | `HexViewer` widget and its FFI seam | done | `4b02300` (#66) |
| B4 | Wire the viewer into the tab area; audit the `CodeEditor` casts | done | `4b02300` (#66) |
| B5 | Stop `looks_binary_file` reporting unreadable files as binary | done | `4b02300` (#66) |
